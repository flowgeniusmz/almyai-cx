...
def fetch_salesforce_data():
    ...
    Created_From_Asset_or_Contract__c, CloseDate, Delivery_Date__c, Amount, Amount__c, Email__c, Install_Date__c, Type, Product__c, 
    Pricebook2Id, RecordTypeId, RecordType.Name, Sales_Rep__c, StageName, Subsidiary__c, Territory2Id 
    FROM Opportunity 
    WHERE Subsidiary__c = 'Alma Lasers , Inc.' and OwnerId = '0055d00000Ccir0AAB'
    ...
    df = pd.DataFrame(columns=[
        ...
        'CreatedDate', 'Created_From_Asset_or_Contract__c', 'CloseDate', 'Delivery_Date__c', 'Amount', 'Amount__c', 
